...
j=0
from PRGLFUTURE import sentance as sentancefuture
from PRGLPASTIMPERFECT  import sentance as sentancepastimperfect
while j<1000:
    try:
        ...
        if lmnop==1:
            ...
            print(sentancefuture())
        else:
             print(sentancepastimperfect())
        print("------")
        j+=1
    except:
        pass
